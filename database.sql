...
CREATE TABLE `redeemrecord` (
  ...
  `Status` enum('Delivered','On the Way','','') NOT NULL,
  `Redeem_TeamID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `redeemrecord` (`Reward_ID`, `RedeemRecord_ID`, `Reward_Name`, `Redeem_Quantity`, `Redeem_By`, `Redeem_Date`, `Status`, `Redeem_TeamID`) VALUES
(2, 1, 'Tree Planting Cert', 1, 27, '2025-12-02', 'Delivered', NULL);
...
INSERT INTO `reward` (`Reward_ID`, `Reward_name`, `Points_Required`, `Stock`, `Type`, `Description`) VALUES
(1, 'Grocer Voucher', 20, 100, 'virtual', 'Voucher to buy grocer'),
(2, 'Tree Planting Cert', 1000, 999, 'virtual', 'We Plant A tree using your name');
...
--
ALTER TABLE `redeemrecord`
  MODIFY `RedeemRecord_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
