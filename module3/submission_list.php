...
// check being login status or not
...
// Here, using `User_ID = ?` ensures that only the current user's data is retrieved.
$sql = "SELECT 
            s.Submission_ID, 
            s.Submission_date, 
...
// --- Count the number of items in each state (for display in the top tabs) ---
$count_sql = "SELECT 
    COUNT(*) as total,
